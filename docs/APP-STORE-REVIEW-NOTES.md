...
- Optional diagnostics/telemetry is **off by default**. The only opt-in is Settings → Privacy → "Share anonymous usage" (EU-hosted product analytics); nothing is transmitted until the user turns it on.
